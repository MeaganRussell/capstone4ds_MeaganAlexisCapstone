...
```
According to the data collected from NOAA, Northwest Florida expereienced 1023 flooding events between January 1, 2000 and December 31, 2025. Flooding event distribution is represented in @fig-flood-event-pie. Of the flooding events, 76.1% are categorized as flash floods and 23.9% are categorized as floods. This data indicates that Northwest Florida counties experience short-duration, high-intensity rainfall events more often then long-duration rainfall events.
